...
public class PaymentPage {
    ...
    // Локатора для оплаты услуг связей
    private By displayedKart = By.cssSelector(".ng-tns-c46-1");
    private By displayedCvc = By.cssSelector(".ng-tns-c46-5");
    private By displayedTime = By.cssSelector(".ng-tns-c46-4");
    private By displayedName = By.cssSelector(".ng-tns-c46-3");
    ...
    //
    public String getPaymentButtonKart() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(displayedKart)).getText();
    }

    public String getPaymentButtonTime() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(displayedTime)).getText();
    }

    public String getPaymentButtonCvc() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(displayedCvc)).getText();
    }

    public String getPaymentButtonName() {
        return wait.until(ExpectedConditions.visibilityOfElementLocated(displayedName)).getText();
    }
